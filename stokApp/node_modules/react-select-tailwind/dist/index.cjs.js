    ...
    return (React__default["default"].createElement(SelectProvider, { otherData: {
        ...
        React__default["default"].createElement("div", { className: "relative w-full", ref: ref },
            React__default["default"].createElement("div", { "aria-expanded": open, onKeyDown: onPressEnterOrSpace, onClick: toggle, className: getSelectClass() },
                React__default["default"].createElement("div", { className: "grow pl-2.5 py-2 pr-2 flex flex-wrap gap-1" }, !isMultiple ? (React__default["default"].createElement("div", { className: "truncate cursor-default select-none" }, value && !Array.isArray(value) ? (React__default["default"].createElement("div", { className: "flex gap-4" },
                    value && value.icon && value.icon,
                    React__default["default"].createElement("p", { className: "truncate cursor-default select-none" }, value.label))) : (placeholder))) : (React__default["default"].createElement(React__default["default"].Fragment, null,
