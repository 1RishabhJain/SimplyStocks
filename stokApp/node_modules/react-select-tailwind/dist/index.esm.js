    ...
    return (React.createElement(SelectProvider, { otherData: {
        ...
        React.createElement("div", { className: "relative w-full", ref: ref },
            React.createElement("div", { "aria-expanded": open, onKeyDown: onPressEnterOrSpace, onClick: toggle, className: getSelectClass() },
                React.createElement("div", { className: "grow pl-2.5 py-2 pr-2 flex flex-wrap gap-1" }, !isMultiple ? (React.createElement("div", { className: "truncate cursor-default select-none" }, value && !Array.isArray(value) ? (React.createElement("div", { className: "flex gap-4" },
                    value && value.icon && value.icon,
                    React.createElement("p", { className: "truncate cursor-default select-none" }, value.label))) : (placeholder))) : (React.createElement(React.Fragment, null,
